...
export const AppRoles = (() => {
    const Employee = {
        name: "Employé",
        code: AppRole.EMPLOYEE,
        description: "Rôle de base pour les employés avec des permissions limitées",
        permissions: [
    ...
    const Manager = {
        ...
        description: "Rôle de manager avec des permissions étendues pour la gestion des équipes",
        permissions: [
    ...
    const Admin = {
        name: "Administrateur",
        code: AppRole.ADMIN,
        description: "Rôle d'administrateur avec des permissions étendues pour la gestion du système",
        permissions: [
            ...Manager.permissions,
            AppPermissions.Administration.VIEW_USERS,
            AppPermissions.Administration.ADD_USERS,
    ...
    return { Employee, Manager, Admin } as const;
})();
