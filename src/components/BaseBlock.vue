<script setup lang="ts">
	...
	const classContainerHeader = computed(() => {
		...
		if (props.headerClass) {
			classes[props.headerClass] = true;
		}
		return classes;
	});
	...
	const classContainerContent = computed(() => {
		return {
			...
			...(props.contentClass ? { [props.contentClass]: true } : {}),
		};
	});
	...
	function statusLoading(mode: string, timeout: number | undefined) {
