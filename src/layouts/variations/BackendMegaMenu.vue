									...
									<div class="col-xxl-6 space-y-4">
										<div>
											...
											<div class="form-check form-switch">
												...
												/>
												<label class="form-check-label fs-sm" for="mega-settings-status"
													>Make visible</label
												>
											</div>
										</div>
										<div>
											...
											<div class="space-y-2">
												<div class="form-check form-switch">
													...
													/>
													<label class="form-check-label fs-sm" for="mega-settings-update-app"
														>Applications</label
													>
												</div>
												<div class="form-check form-switch">
													<input
														...
														checked
													/>
													<label class="form-check-label fs-sm" for="mega-settings-update-sales"
														>Sales</label
													>
												</div>
											</div>
											...
											<div class="space-y-2">
												<div class="form-check form-switch">
													<input
														...
														checked
													/>
													<label class="form-check-label fs-sm" for="mega-settings-email"
												...
												<div class="form-check form-switch">
													...
													/>
													<label class="form-check-label fs-sm" for="mega-settings-sms"
										...
										<div>
											...
											<div class="form-check form-switch">
												<input
													...
													checked
												/>
												<label class="form-check-label fs-sm" for="mega-settings-api"
													>Enable access</label
												>
											</div>
										</div>
