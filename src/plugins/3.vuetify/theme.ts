...
export const staticSecondaryDarkenColor = "#007CB3";
export const staticWarningColor = "#F1701A";
export const staticWarningDarkenColor = "#CC5D17";
export const staticBackgroundColor = "#FFFFFF";
export const staticBackgroundOnColor = "#63666A";
...
export const themes: Record<string, ThemeDefinition> = {
	light: {
		...
		colors: {
			...
			"on-secondary": "#fff",
			success: "#3B927E",
			"success-darken-1": "#006633",
			"on-success": "#fff",
			info: staticSecondaryColor,
			"info-darken-1": staticSecondaryDarkenColor,
			"on-info": "#fff",
			warning: staticWarningColor,
			"warning-darken-1": staticWarningDarkenColor,
			"on-warning": "#fff",
			error: "#FF4D49",
			"error-darken-1": "#E64542",
			"on-error": "#fff",
			background: staticBackgroundColor,
			"on-background": staticBackgroundOnColor,
			surface: staticBackgroundColor,
			"on-surface": staticBackgroundOnColor,
