...
<template>
  ...
  -->					
	...
	<nav id="sidebar" :class="{ 'with-mini-nav pl-0': withMiniNav }" aria-label="Main Navigation">
		<div>
			<!-- Side Header -->
			<div class="content-header justify-end py-3 mx-0">
				<slot name="header">
					<div class="">
						<h2 class="text-2xl font-extrabold text-green-700 font-[Quicksand, sans-serif] mb-0">TEA</h2>
				<p class="text-xs font-extrabold text-green-700 font-[Quicksand, sans-serif] mb-0">Services</p>
					</div>
					<!-- Logo -->
					<!-- <RouterLink to="dashboard" class="fw-semibold text-dual"> -->
					<!-- </RouterLink> -->
					<!-- END Logo -->
				</slot>
